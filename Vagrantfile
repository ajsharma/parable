...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision :shell, path: "vagrant/tools.sh", keep_color: true
  config.vm.provision :shell, path: "vagrant/heroku-toolbelt.sh", keep_color: true
  config.vm.provision :shell, path: "vagrant/firefox.sh", keep_color: true
  config.vm.provision :shell, path: "vagrant/swap.sh", keep_color: true
